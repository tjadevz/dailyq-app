...
export const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    onboarding_intro_tagline: "The easiest way to watch yourself change",
    onboarding_intro_past_answers: "Your Past Answers",
    onboarding_intro_example_question:
      "Who would you have dinner with if you could choose anyone?",
    onboarding_intro_example_month_1: "February 2026",
    onboarding_intro_example_answer_1: "My grandmother",
    onboarding_intro_example_month_2: "February 2025",
    onboarding_intro_example_answer_2: "My grandfather",
    ...
    onboarding_notif_morning_time: "Start your day (9:00 AM)",
    onboarding_notif_afternoon: "Afternoon",
    onboarding_notif_afternoon_time: "Midday pause (2:00 PM)",
    onboarding_notif_evening: "Evening",
    onboarding_notif_evening_time: "Wind down (7:00 PM)",
    ...
    streak_popup_subtitle_30:
      "Incredible! You've answered for 30 days straight!",
    streak_popup_subtitle_100:
      "Incredible! You've answered for 100 days straight!",
  ...
  nl: {
    ...
    onboarding_intro_tagline: "De makkelijkste manier om jezelf te zien veranderen",
    onboarding_intro_past_answers: "Je eerdere antwoorden",
    onboarding_intro_example_question:
      "Met wie zou je willen dineren als je iemand mocht kiezen?",
    onboarding_intro_example_month_1: "Februari 2026",
    onboarding_intro_example_answer_1: "Mijn oma",
    onboarding_intro_example_month_2: "Februari 2025",
    onboarding_intro_example_answer_2: "Mijn opa",
    ...
    onboarding_notif_morning_time: "Start je dag (9:00)",
    onboarding_notif_afternoon: "Middag",
    onboarding_notif_afternoon_time: "Pauze (14:00)",
    onboarding_notif_evening: "Avond",
    onboarding_notif_evening_time: "Aan het eind van de dag (19:00)",
    ...
    streak_popup_subtitle_30:
      "Ongelooflijk! Je hebt 30 dagen achter elkaar beantwoord!",
    streak_popup_subtitle_100:
      "Ongelooflijk! Je hebt 100 dagen achter elkaar beantwoord!",
