...
> = {
  en: {
    ...
    joker_modal_body: "You have {joker_balance} jokers.\n\nWith a joker you can still answer a missed day from the last 7 days.",
    ...
    settings_version: "Version 1.3.1",
  ...
  nl: {
    ...
    joker_modal_title_one: "Joker",
    joker_modal_title_many: "Jokers",
    joker_modal_body: "Je hebt {joker_balance} jokers.\n\nMet een joker kun je een gemiste dag binnen de afgelopen 7 dagen alsnog beantwoorden.",
    ...
    missed_use_joker_message: "Je hebt deze dag gemist. Met een joker kun je de vraag alsnog beantwoorden.",
