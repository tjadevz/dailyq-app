...
> = {
  en: {
    ...
    recap_joker_cta: "Use a joker to answer a missed day",
    // Today view
  ...
  nl: {
    ...
    recap_joker_cta: "Gebruik een joker om een gemiste dag te beantwoorden",
    ...
    streak_popup_joker_count: "1 Joker",
    streak_popup_joker_hint: "Gebruik hem om een gemiste dag te beantwoorden",
    streak_popup_cta: "Ga zo door!",
